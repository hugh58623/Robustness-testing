...
from perturbnew import read_config
...
def report_results(args):
    ...
    for model in args.models:
        for dataset in args.datasets:
            ...
            data_nominal_completed_path = args.nominal_result_path
            ...
            for aug_method in range(len(RECIPES[args.method])):
                ...
                for seed in range(args.n_outputs):
                    ...
                    data_perturbed_completed_path = args.perturbed_result_path
...
if __name__ == '__main__':
    ...
    parser.add_argument('--metric', type=str, default="all", choices=["passatk", "drop", "relative", "attack_success", "all"], help="The metric used for reporting results.")
    ...
    parser.add_argument('--perturbed_result_path', type=str, default="/home/yangliu6/scratch/recode/testdata_eval/nomoadv/result.jsonl", help="the absolute path of perturbed result path.")
    parser.add_argument('--nominal_result_path', type=str, default="/home/yangliu6/scratch/recode/testdata_eval/mono/result.jsonl", help="the absolute path of nominal result path.")

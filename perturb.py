...
def get_languages(data):
    if data in ["humaneval", "mbpp","classeval"]:
        return "python"
    if data in ["python"]:
        return data
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default="humaneval", choices=["humaneval", "mbpp", "mbjp", "mbjsp", "mbkp", "mbphp", "mbrbp", "classeval"])
